...
export default function OffersForm({ setService, setIsNfz, setRefferalNumber }) {
    ...
    return (
        !loading ? <TabsForm
            ...
            contents={{
                "Wizyty prywatne": <OffersAccordionForm setIsNfz={setIsNfz} setRefferalNumber={setRefferalNumber} isNfzAccordion={false} setService={setService} offersData={offersData.filter((item) => item.privateOffer)} offersCategories={offersCategories.filter((category) =>
                    offersData.some((offer) => offer.category === category.id && offer.privateOffer)
                )} />,
                "Wizyty na NFZ": <OffersAccordionForm setIsNfz={setIsNfz} setRefferalNumber={setRefferalNumber} isNfzAccordion={true} setService={setService} offersData={offersData.filter((item) => item.nfz)} offersCategories={offersCategories.filter((category) =>
