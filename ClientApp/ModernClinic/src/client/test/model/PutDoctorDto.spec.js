...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenApiDefinition.PutDoctorDto();
  });
  ...
  describe('PutDoctorDto', function() {
    it('should create an instance of PutDoctorDto', function() {
      // uncomment below and update the code to test PutDoctorDto
      //var instance = new OpenApiDefinition.PutDoctorDto();
      //expect(instance).to.be.a(OpenApiDefinition.PutDoctorDto);
    });
