...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenApiDefinition.Doctor();
  });
  ...
  describe('Doctor', function() {
    it('should create an instance of Doctor', function() {
      // uncomment below and update the code to test Doctor
      //var instance = new OpenApiDefinition.Doctor();
      //expect(instance).to.be.a(OpenApiDefinition.Doctor);
    });
